...
class DocumentProcessor:
    """
    Orchestrates the document processing pipeline and selects the appropriate classifier based on document style.
    """
    ...
    def process_document(self, pdf_path: str) -> str:
        """
        Executes the full processing pipeline for a given PDF and returns the resulting JSON string.
        """
